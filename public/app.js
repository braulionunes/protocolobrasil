...
async function init() {
  const steps = [
    { t: 'Conectando ao banco Supabase...', p: 25 },
    { t: 'Carregando 112 PCDTs CONITEC/MS...', p: 55 },
    { t: 'Verificando conectividade da API...', p: 80 },
    { t: 'Iniciando ProtocoloBrasil...', p: 97 },
  ];
  ...
  // Testa conectividade ao analytics (banco Supabase)
  try {
    const r = await fetch(API.analytics + '?limit=1');
    ...
    document.getElementById('dbstat').textContent = 'Banco offline — modo local';
  }
