...
"insuficiencia cardiaca":{area:"Cardiologia",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 6, de 22 de fevereiro de 2024",
  ...
  meds_exatos:{
    ...
    "FEVE ≤35% — adicionar ao tratamento otimizado":["Sacubitril 24mg + Valsartana 26mg (comprimido) — 2x/dia (substituir IECA/BRA)","Sacubitril 49mg + Valsartana 51mg (comprimido) — dose intermediária 2x/dia","Sacubitril 97mg + Valsartana 103mg (comprimido) — dose alvo 2x/dia","Dapagliflozina 10mg (comprimido) — 1x/dia","Empagliflozina 10mg (comprimido) — 1x/dia","Ivabradina 5mg / 7,5mg (comprimido) — 2x/dia se FC ≥70 em ritmo sinusal"]},
...
"dislipidemia":{area:"Cardiologia",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 4, de 22 de fevereiro de 2024",
  ...
  meds_exatos:{
    ...
    "3ª LINHA — muito alto risco refratário (LDL ≥70 com estatina máx + ezetimiba)":["Evolocumabe 140mg/mL (solução injetável, seringa 1mL) — 140mg SC a cada 2 semanas OU 420mg SC 1x/mês"],
...
"artrite reumatoide":{area:"Reumatologia",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 34, de 23 de janeiro de 2026",
  ...
  meds_exatos:{
    ...
    "2ª linha após falha anti-TNF":["Rituximabe 500mg / 1000mg (frasco IV) — 1000mg IV dia 1 e 15; repetir a cada 24 semanas"]},
...
"carcinoma de mama":{area:"Oncologia",comp:"DDT",portaria:"CONITEC DDTs Mama vigentes 2024-2025",
  ...
  meds_exatos:{
    "HER2+ — terapia alvo":["Trastuzumabe 150mg / 440mg (frasco IV) — 8mg/kg semana 0; 6mg/kg a cada 3 semanas","Pertuzumabe 420mg/14mL (frasco IV) — 840mg semana 0; 420mg a cada 3 semanas (com trastuzumabe)","Trastuzumabe deruxtecano 100mg (pó IV) — 5,4mg/kg a cada 3 semanas (HER2+ metastático pós-1ª linha)"],
...
"adenocarcinoma de prostata":{area:"Oncologia",comp:"DDT",portaria:"CONITEC DDTs Próstata vigentes 2024-2025",
  ...
  meds_exatos:{
    ...
    "mCRPC — castração-resistente":["Enzalutamida 40mg (cápsula) — 160mg 1x/dia","Abiraterona 250mg (comprimido) — 1000mg 1x/dia jejum + prednisona 5mg 2x/dia","Docetaxel IV — 75mg/m² a cada 3 semanas","Cabazitaxel 60mg/1,5mL (IV) — 25mg/m² a cada 3 semanas (pós-docetaxel)"],
...
"carcinoma colorretal":{area:"Oncologia",comp:"DDT",portaria:"CONITEC DDTs CCR vigentes 2024-2025",
  ...
  meds_exatos:{
    ...
    "Anti-EGFR — APENAS RAS/BRAF wild-type":["Cetuximabe 5mg/mL (frasco IV) — 400mg/m² semana 1; 250mg/m² semanal (APENAS se RAS WT confirmado)"]},
...
"dpoc":{area:"Pneumologia",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 29, de 16 de janeiro de 2025",
  ...
  meds_exatos:{
    ...
    "ADJUVANTE — casos específicos":["Roflumilaste 500mcg (comprimido) — 1x/dia (VEF1 <50% + bronquite + ≥2 exacerbações)"],
  ...
  meds:["Salbutamol 100mcg (resgate — grupo A)","Umeclidínio 62,5mcg + Vilanterol 25mcg (grupos B e E sem ICS)","Furoato Fluticasona 100mcg + Umeclidínio 62,5mcg + Vilanterol 25mcg — TERAPIA TRIPLA","Beclometasona 100mcg + Formoterol 6mcg + Glicopirrônio 12,5mcg — TERAPIA TRIPLA","Roflumilaste 500mcg (adjuvante)"]},
...
"acromegalia":{area:"Endocrinologia",comp:"CEAF",portaria:"Portaria SAES/SECTICS/MS nº 23, de 2025",
  ...
  meds_exatos:{
    ...
    "2ª linha":["Pasireotida LAR 20mg / 40mg / 60mg (pó IM) — 40mg IM a cada 4 semanas","Pegvisomanto 10mg / 15mg / 20mg (pó SC) — 10-30mg SC/dia"],
...
"osteoporose":{area:"Reumatologia/Endocrinologia",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 9, de 2022",
  ...
  meds_exatos:{
    ...
    "Osteoporose grave — anabólico":["Teriparatida 250mcg/mL (caneta SC) — 20mcg SC/dia (máx 24 meses)","Romosozumabe 105mg/1,17mL (seringa SC) — 210mg SC 1x/mês ×12 meses"]},
...
"esclerose multipla":{area:"Neurologia",comp:"CEAF",portaria:"Portaria SAES/SECTICS/MS nº 8, de 2024",
  ...
  meds_exatos:{
    ...
    "3ª LINHA — EMRR altamente ativa refratária":["Alentuzumabe 12mg/1,2mL (frasco IV) — 12mg IV/dia ×5 dias; depois ×3 dias após 12 meses","Cladribina 10mg (comprimido) — 3,5mg/kg em 2 ciclos anuais"],
...
"atrofia muscular espinhal":{area:"Neurologia/Pediatria",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 13, de 2023",
  ...
  meds_exatos:{
    "≤2 anos + ≤3 cópias SMN2 — terapia gênica (dose ÚNICA)":["Onasemnogene abeparvovec-xioi 2×10¹⁴ vg/kg (concentrado IV) — dose única IV"],
...
"epilepsia":{area:"Neurologia",comp:"CEAF",portaria:"Portaria SAS/SCTIE/MS nº 17, de 2018 + atualizações",
  ...
  meds_exatos:{
    ...
    "APENAS Dravet OU Lennox-Gastaut refratários":["Canabidiol 100mg/mL (solução oral) — 2,5mg/kg 2x/dia; titular até 10mg/kg 2x/dia"]},
...
"doenca de crohn":{area:"Gastroenterologia",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 9, de 2022",
  ...
  meds_exatos:{
    ...
    "Não anti-TNF — 2ª linha":["Ustecinumabe 130mg IV (indução por peso); depois 90mg SC a cada 12 semanas","Vedolizumabe 300mg IV — 300mg semanas 0,2,6; depois a cada 8 semanas","Risanquizumabe 600mg IV (3 doses); depois 360mg SC a cada 8 semanas"]},
...
"retocolite ulcerativa":{area:"Gastroenterologia",comp:"CEAF",portaria:"Portaria SAES/SECTICS/MS nº 9, de 2024",
  ...
  meds_exatos:{
    ...
    "JAK — após falha a biológico":["Tofacitinibe 5mg / 10mg (comprimido) — 10mg 2x/dia ×8 semanas; depois 5mg 2x/dia"]},
...
"hiv aids":{area:"Infectologia",comp:"Estratégico",portaria:"Portaria SAES/SCTIE/MS nº 1, de 2023",
  ...
  meds_exatos:{
    ...
    "Injetável de longa duração":["Cabotegravir 600mg/3mL (suspensão IM) + Rilpivirina 900mg/3mL (suspensão IM) — 1 de cada a cada 2 meses"],
...
"tuberculose":{area:"Infectologia",comp:"Estratégico",portaria:"Manual TB MS 2024",
  ...
  meds_exatos:{
    ...
    "TB-MDR":["Bedaquilina 100mg (comprimido) — 400mg/dia ×2 semanas; depois 200mg 3x/semana ×22 semanas","Linezolida 600mg (comprimido) — 600mg/dia","Clofazimina 100mg (cápsula) — 100mg/dia"]},
...
"hemofilia":{area:"Hematologia",comp:"Estratégico",portaria:"Portaria SAES/SCTIE/MS nº 3, de 2022",
  ...
  meds_exatos:{
    ...
    "HEMOFILIA A com inibidor":["Emicizumabe 30mg/mL / 60mg/mL / 105mg/mL / 150mg/mL (seringa SC) — profilaxia 3mg/kg/semana ×4; depois 1,5mg/kg/semana","Fator VIIa recombinante 1mg (frasco IV) — sangramento episódico","FEIBA 500UI / 1000UI (frasco IV) — sangramento episódico"],
...
"mieloma multiplo":{area:"Hematologia",comp:"CEAF/DDT",portaria:"CONITEC DDTs Mieloma vigentes 2024-2025",
  ...
  meds_exatos:{
    ...
    "Recidivado/Refratário":["Pomalidomida 4mg (cápsula) — 4mg dias 1-21 a cada 4 semanas","Carfilzomibe 60mg (frasco IV) — em combinação","Ixazomibe 4mg (cápsula) — a cada 2 semanas oral"]},
  meds:["Bortezomibe SC","Lenalidomida","Dexametasona","Daratumumabe IV","Melfalan","Pomalidomida","Carfilzomibe IV","Ixazomibe"]},

"artrite idiopatica juvenil":{area:"Reumatologia/Pediatria",comp:"CEAF",portaria:"Portaria SAES/SCTIE/MS nº 34, de 23 de janeiro de 2026",criterios:["Critérios ILAR","Início <16 anos","Falha ao MTX ≥3 meses","Canacinumabe: exclusivo AIJ sistêmica com febre recorrente"],meds:["Metotrexato 2,5mg","Leflunomida 20mg","Adalimumabe 40mg SC","Etanercepte 50mg SC","Abatacepte SC","Tocilizumabe IV/SC","Canacinumabe 150mg SC (AIJ sistêmica)","Baricitinibe 4mg"]},
...
"sindrome de sjogren":{area:"Reumatologia",comp:"Básico/CEAF",portaria:"Diretriz SBR",criterios:["ACR/EULAR 2016","Anti-SSA/Ro positivo"],meds:["Hidroxicloroquina 400mg","Pilocarpina 5mg (sialogogo)","Rituximabe IV (manifestações sistêmicas graves)"]},
